...
var literalNames = [ null, "'create'", "'copy'", "'h1'", null, "'insert'", 
                     ...
                     "'text'", "'function'", "'heroTitle'", "'heroSubtitle'", 
...
var symbolicNames = [ null, "CREATE", "COPY", "H1", "HTML", "INSERT", "FROM", 
                      ...
                      "FUNCTION", "HEROTITLE", "HEROSUBTITLE", "HEROURL", 
                      "HEROIMG", "ALIGNMENT", "TK_NUM", "STRING", "TK_DOS_PUNTOS", 
...
einfachParser.HEROTITLE = 25;
einfachParser.HEROSUBTITLE = 26;
einfachParser.HEROURL = 27;
einfachParser.HEROIMG = 28;
einfachParser.ALIGNMENT = 29;
einfachParser.TK_NUM = 30;
einfachParser.STRING = 31;
einfachParser.TK_DOS_PUNTOS = 32;
einfachParser.TK_SUMA_ASIG = 33;
einfachParser.TK_MENOS_ASIG = 34;
einfachParser.TK_ASIG = 35;
einfachParser.TK_COMA = 36;
einfachParser.TK_COR_DER = 37;
einfachParser.TK_COR_IZQ = 38;
einfachParser.TK_DISTINTO = 39;
einfachParser.TK_EJECUTA = 40;
einfachParser.TK_IGUAL = 41;
einfachParser.TK_MENORQUE = 42;
einfachParser.TK_MAYORQUE = 43;
einfachParser.TK_EXPR_SINC = 44;
einfachParser.TK_MULTI = 45;
einfachParser.TK_PAR_IZQ = 46;
einfachParser.TK_PAR_DER = 47;
einfachParser.TK_PUNTO_Y_COMA = 48;
einfachParser.TK_MENOS_MENOS = 49;
einfachParser.TK_MENOS = 50;
einfachParser.TK_SEPARA = 51;
einfachParser.TK_SUMA_SUMA = 52;
einfachParser.TK_SUMA = 53;
einfachParser.TK_DIV = 54;
einfachParser.TK_PUNTO = 55;
einfachParser.TK_SWAP = 56;
einfachParser.TK_TRES_PUNTOS = 57;
einfachParser.TK_PORCENTAJE = 58;
einfachParser.TK_AMPERSAND = 59;
einfachParser.TK_LLAVE_IZQ = 60;
einfachParser.TK_LLAVE_DER = 61;
einfachParser.TK_COMILLA = 62;
einfachParser.HTML_CODE = 63;
einfachParser.ANY = 64;
einfachParser.WS = 65;
...
einfachParser.prototype.parameter_specification = function() {
    ...
    try {
        ...
        this.state = 76;
        _la = this._input.LA(1);
        if(!((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << einfachParser.URL) | (1 << einfachParser.SIZE) | (1 << einfachParser.TEXT) | (1 << einfachParser.FUNCTION) | (1 << einfachParser.HEROTITLE) | (1 << einfachParser.HEROSUBTITLE) | (1 << einfachParser.HEROURL) | (1 << einfachParser.HEROIMG) | (1 << einfachParser.ALIGNMENT))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
